...
app.post('/application', application.addApplication);
...
app.get('/applications/:app_id/rules', application.getRules);
...
app.post('/applications/:app_id/typeEvent', typeEvent.addTypeEvent);
...
// RULES
app.post('/applications/:app_id/rule', rule.addRule);
